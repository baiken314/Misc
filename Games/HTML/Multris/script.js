...
var pieces = [tPiece, lPiece, jPiece, zPiece, sPiece, iPiece, oPiece, xxPiece, uPiece, btPiece, bcPiece, bsPiece, bzPiece, blPiece, bjPiece, pzPiece, psPiece, ltlPiece, ltrPiece, stPiece, bmsPiece, bmzPiece, biPiece, bopPiece, bolPiece, mPiece, dPiece, tcPiece, tiPiece];
...
function getColorByPieceCode(pieceCode) {
    if (pieceCode == "t")
        ...
        return "#fc1";
    else if (pieceCode == "xx")
        return "#678";
    else if (pieceCode == "u")
        return "#7d8";
    else if (pieceCode == "bt")
        return "#c9f";
    else if (pieceCode == "bc")
        return "#f9f";
    else if (pieceCode == "bs")
        return "#6f9";
    else if (pieceCode == "bz")
        return "#c94";
    else if (pieceCode == "bl")
        return "#c49";
    else if (pieceCode == "bj")
        return "#9c6";
    else if (pieceCode == "pz")
        return "#6cc";
    else if (pieceCode == "ps")
        return "#ccb399";
    else if (pieceCode == "ltl")
        return "#98a";
    else if (pieceCode == "ltr")
        return "#c66";
    else if (pieceCode == "st")
        return "#fcc";
    else if (pieceCode == "bms")
        return "#ff9";
    else if (pieceCode == "bmz")
        return "#f22175";
    else if (pieceCode == "bi")
        return "#f3b";
    else if (pieceCode == "bop")
        return "#29f";
    else if (pieceCode == "bol")
        return "#4ba";
    else if (pieceCode == "m")
        return "#74d";
    else if (pieceCode == "d")
        return "#ff5050";
    else if (pieceCode == "ti")
        return "#d7a";
    else if (pieceCode == "tc")
        return "#a44";
    else if (pieceCode == "white")
        return "#eee";
    else
        return "#a99";
}
...
function drawMap() {
    ...
    for (let y = 1; y < mapHeight; y++) {
        ...
        ctx.lineTo((mapWidth + 7 - 1)*SCALE, y*SCALE);
        ctx.stroke();
        ctx.closePath();
    }
    for (let x = 1; x < mapWidth; x++) {
        ctx.beginPath();
        ctx.moveTo((7 + x)*SCALE, 0);
        ctx.lineTo((7 + x)*SCALE, (mapHeight - 1)*SCALE);
        ctx.stroke();
        ctx.closePath();
    }*/
}
...
function main() {
    ...
    if (fallTimer % currentFallDelay == 0 && blockTimer <= 0 && lineClearTimer <= 0) {
        ...
        // piece hits ground
            ...
            // check for game over, reset variables
